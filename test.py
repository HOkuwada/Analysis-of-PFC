...
FOOD_DB = {
    ...
    "夕食": {
        ...
        "ツナ缶パスタ": {"kcal": 650.0, "p": 25.0, "f": 15.0},
        "明太パスタ": {"kcal": 600.0, "p": 18.0, "f": 12.0},
        "鯖缶パスタ": {"kcal": 720.0, "p": 35.0, "f": 25.0},
